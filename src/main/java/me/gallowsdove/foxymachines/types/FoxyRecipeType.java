...
public class FoxyRecipeType {
    private static final ItemStack QUEST_ITEM = CustomItemStack.create(Material.MOJANG_BANNER_PATTERN, "&6Quest Reward", "", "&e&oGet this by completing the quest with the sword.",
    ...
    public static RecipeType SACRIFICIAL_ALTAR = new RecipeType(new NamespacedKey(FoxyMachines.getInstance(), "sacrificial_altar"),
             CustomItemStack.create(Material.POLISHED_BLACKSTONE_BRICKS, "&cSacrificial Altar", "", "&e&oSacrifice the mob in the Sacrificial Altar",
    ...
    public static RecipeType FISHING = new RecipeType(new NamespacedKey(FoxyMachines.getInstance(), "fishing"),
            CustomItemStack.create(Material.FISHING_ROD, "&bFishing", "", "&e&oGet this as a fishing loot."));
    ...
    public static RecipeType CUSTOM_MOB_DROP = new RecipeType(new NamespacedKey(FoxyMachines.getInstance(), "mob_drop"),
            CustomItemStack.create(Material.DIAMOND_SWORD, "&aUnique Mob Drop", "", "&e&oObtained by killing the specified mob."));
}
