...
public class PotionMixer extends SlimefunItem implements EnergyNetComponent {
    ...
    public PotionMixer() {
        super(Items.MACHINES_ITEM_GROUP, Items.POTION_MIXER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                SlimefunItems.ELECTRIC_MOTOR.item(), new ItemStack(Material.BREWING_STAND), SlimefunItems.ELECTRIC_MOTOR.item(),
    ...
    protected void tick(@Nonnull Block b) {
        ...
        if (isProcessing(b)) {
            ...
            if (timeleft > 0) {
                ...
                inv.replaceExistingItem(13, CustomItemStack.create(Material.BLACK_STAINED_GLASS_PANE, " "));
    ...
    protected void constructMenu(@Nonnull BlockMenuPreset preset) {
        ...
        for (int i : BORDER_IN) {
            preset.addItem(i, new SlimefunItemStack("_UI_INPUT_SLOT", Material.CYAN_STAINED_GLASS_PANE, " ").item(), ChestMenuUtils.getEmptyClickHandler());
        }

        for (int i : BORDER_OUT) {
            preset.addItem(i, new SlimefunItemStack("_UI_OUTPUT_SLOT", Material.ORANGE_STAINED_GLASS_PANE, " ").item(), ChestMenuUtils.getEmptyClickHandler());
        }

        preset.addItem(13, CustomItemStack.create(Material.BLACK_STAINED_GLASS_PANE, " "), ChestMenuUtils.getEmptyClickHandler());
